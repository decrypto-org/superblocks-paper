\begin{abstract}
  ...
  interlink data structure. We observe that repeated superblock references within an interlink can be omitted
  ...
  interlink sizes (which we improve by $79\%$) and the sizes of succinct NIPoPoWs (which we improve by $37\%$). As such, our results allow superlight clients to synchronize $37\%$ faster than previous work.
\end{abstract}
